...
export const profile = {
  ...
  bio: [
    "Full-Stack Java Developer with 4+ years of experience delivering enterprise-grade applications using Java, Spring Boot, React, and PostgreSQL.",
    "Proven track record in microservices architecture, RESTful API design, Redis caching, and AWS cloud services. Achieved 99.9% uptime across production systems and 40% faster API response times.",
